...
<template>
  <div>
    ...
    <textarea v-model="doc" :disabled="!ownedByMe" />
    <button v-if="!ownedByMe" @click="claim()">Edit</button>
    <button v-else @click="release({ changed: true })">Save</button>
  </div>
</template>
```
...
<template>
  <div>
    ...
    <input v-model="title" :disabled="!ownedByMe" />
    <button v-if="!ownedByMe" :disabled="!!ownerInfo" @click="claim()">
      Edit title
    </button>
    <button v-else @click="release({ changed: true })">Done</button>
