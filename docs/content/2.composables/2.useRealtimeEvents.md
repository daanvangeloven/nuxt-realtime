  ...
  <div class="space-y-2">
    <div class="space-y-1">
      <p
        ...
        :key="msg.id"
        :class="msg.userId === userId ? 'text-primary text-right' : 'text-muted'"
      >
        {{ msg.text }}
      </p>
    </div>
    <form class="flex gap-2" @submit.prevent="sendMessage">
      <UInput v-model="input" placeholder="Type a message..." class="flex-1" />
...
<template>
  <div class="flex gap-2">
    <UButton color="success" @click="notifyAll('success')">Success</UButton>
    <UButton color="info" @click="notifyAll('info')">Info</UButton>
    <UButton color="warning" @click="notifyAll('warning')">Warning</UButton>
    <UButton color="error" @click="notifyAll('error')">Error</UButton>
  </div>
</template>
```
...
<template>
  <div class="space-y-2">
    <UInput placeholder="Type something..." @input="onInput" />
    <UBadge v-if="typingUsers.size > 0" color="neutral" variant="subtle">
