...
Pass options to the underlying Engine.IO server via `socketio.serverOptions`. See the [Socket.IO server options reference](https://socket.io/docs/v4/server-options/) for all available options.
